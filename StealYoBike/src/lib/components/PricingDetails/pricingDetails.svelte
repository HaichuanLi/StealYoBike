...
{#if pricing}
	<div class="mb-16 grid gap-8 md:grid-cols-2">
			...
			<div class="space-y-4">
				<div class="flex items-center justify-between border-b border-gray-100 py-3">
					...
					<span class="text-2xl font-bold text-emerald-600"
						>{formatPrice(pricing.standardBike.baseFee)}</span
					>
				</div>
				<div class="flex items-center justify-between border-b border-gray-100 py-3">
					<span class="text-gray-700">Per Minute Rate</span>
					<span class="text-2xl font-bold text-emerald-600"
						>{formatPrice(pricing.standardBike.perMinuteRate)}</span
					>
				</div>
		...
		<!-- E-Bikes -->
		<div class="rounded-2xl border-2 border-emerald-200 bg-white p-8 shadow-lg">
			<div class="mb-2 text-center">
				<span
					class="inline-block rounded-full bg-emerald-500 px-3 py-1 text-sm font-semibold text-white"
				>
					PREMIUM
				</span>
			</div>
			...
			<div class="space-y-4">
				<div class="flex items-center justify-between border-b border-gray-100 py-3">
					<span class="text-gray-700">Base Fee</span>
					<span class="text-2xl font-bold text-emerald-600"
						>{formatPrice(pricing.eBike.baseFee)}</span
					>
				</div>
				<div class="flex items-center justify-between border-b border-gray-100 py-3">
					<span class="text-gray-700">Per Minute Rate</span>
					<span class="text-2xl font-bold text-emerald-600"
						>{formatPrice(pricing.eBike.perMinuteRate)}</span
					>
				</div>
				<div class="flex items-center justify-between border-b border-gray-100 py-3">
					<span class="text-gray-700">E-Bike Surcharge</span>
					<span class="text-2xl font-bold text-orange-500"
						>+{formatPrice(pricing.eBike.surcharge)}</span
					>
				</div>
				<div class="flex items-center justify-between py-3">
					<span class="text-gray-700">Reservation</span>
	...
	<div class="mb-16">
		...
		<div class="grid gap-8 md:grid-cols-3">
			...
			<!-- Monthly Plan -->
			<div
				class="scale-105 transform rounded-2xl border-2 border-emerald-500 bg-white p-8 shadow-lg"
			>
			...
			<div class="rounded-2xl bg-white p-8 shadow-lg">
				...
				<div class="mb-6">
					...
					<div class="text-sm font-semibold text-green-600">Save $149!</div>
				</div>
				<ul class="mb-8 space-y-3">
					<li class="flex items-center">
						<span class="mr-3 text-green-500">✓</span>
