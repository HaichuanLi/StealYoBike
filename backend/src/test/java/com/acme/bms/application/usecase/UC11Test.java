...
class UC11Test {
    ...
    void studentGetsStudentBillCalculation() {
        ...
        User rider = User.builder().id(101L).email("123123@school.edu").username("123").fullName("123").passwordHash("x").build();
    ...
    Trip trip = Trip.builder()
        ...
        // expected for student regular 10 minutes: base 2 + usage 10*0.10 = 3.0 -> 10% discount = 2.7
    ...
    void nonStudentElectricGetsNonStudentCalculation() {
        ...
        User rider = User.builder().id(102L).email("bob@example.com").username("bob").fullName("Bob").passwordHash("x").build();
    ...
    Trip trip = Trip.builder()
        ...
        // expected for non-student electric 20 minutes: base 2.5 + usage 20*0.15 = 5.5 -> *1.5 = 8.25
