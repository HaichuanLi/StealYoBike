...
class UC8Test {
    ...
    void execute_restoresSystem_andPublishesEvent() {
        ...
        System.out.println("  BikeA: status=" + bikeA.getStatus() + ", dock=" + (bikeA.getDock() != null) + ", expiry="
    ...
    void execute_throws_whenOperatorMissing() {
        ...
        verifyNoInteractions(stationRepository, bikeRepository, reservationRepository, tripRepository, eventPublisher);
    ...
    void execute_returnsOnTripBikesToDocks() {
        ...
        System.out.println("  Dock bike: " + (emptyDock.getBike() != null ? emptyDock.getBike().getId() : "null"));
